...
// Pesos padrão (inspirados na tabela: sono 20, exercício 15, família 15, estudo 10, água 5)
...
// Monta tarefa com config do usuário aplicada
export function buildTasks(taskConfig) {
  return TASKS_META.map(meta => {
...
export function getEarned(t, v) {
  if (!v && v !== 0) return 0;
  if (t.type === "essencial") return v === true ? (Array.isArray(t.points)?t.points:t.points) : 0;
